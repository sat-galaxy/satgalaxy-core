...
extern "C"
{
    ...
    /// @param solver 
    /// @return boolean value
    int glucose_add_empty_clause(const void *solver); 
    ...
    int glucose_nassigns(const void *solver);
    /// @brief The current number of original clauses.
    /// @param solver 
    /// @return 
    int glucose_nclauses(const void *solver); 
    /// @brief The current number of learnt clauses.
    /// @param solver 
    /// @return 
    int glucose_nlearnts(const void *solver); 
    /// @brief The current number of variables.
    /// @param solver 
    /// @return 
    int glucose_nvars(const void *solver);
